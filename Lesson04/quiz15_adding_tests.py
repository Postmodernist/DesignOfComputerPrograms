...
>>> bridge_problem([0,2,5,10])
[(frozenset([0, 'light', 2, 10, 5]), frozenset([]), 0), (2, 0, '->'), (frozenset([10, 5]), frozenset([0, 'light', 2]), 2), (0, 0, '<-'), (frozenset([0, 'light', 10, 5]), frozenset([2]), 2), (5, 10, '->'), (frozenset([0]), frozenset(['light', 2, 10, 5]), 12), (2, 2, '<-'), (frozenset([0, 'light', 2]), frozenset([10, 5]), 14), (2, 0, '->'), (frozenset([]), frozenset([0, 'light', 10, 2, 5]), 16)]
