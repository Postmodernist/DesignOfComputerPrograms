...
# print(condP(two_boys, one_boy))  # 1/3
...
boy_tuesday = [s for s in two_kids_bday if 'BTue' in s]

# print(condP(two_boys, boy_tuesday))


month = 'Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec'.split()
two_kids_bmonth = list(product(sex, month, sex, month))
boy_anyday =   [s for s in two_kids_bday if 'B' in s]
boy_december = [s for s in two_kids_bmonth if 'BDec' in s]
